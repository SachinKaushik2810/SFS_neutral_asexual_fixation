...
if __name__=="__main__":
	...
	for j in range(1,1000):
		file_path=f"/work/users/s/a/sackau/UNC_work/N_1000_s_0.01_h_0.5/Post_fixation/h_0.5/N_500/txt_files/{i}/N_500_output_t_100_subs_off_{(i-1)*1000+j}.txt"
		try:
			with open(file_path,'r'):
				...
				output_folder=f"/work/users/s/a/sackau/UNC_work/N_1000_s_0.01_h_0.5/Post_fixation/h_0.5/N_500/N_500_average_data"
